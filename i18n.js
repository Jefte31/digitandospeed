(() => {
  ...
  const M = {
    en: {
      ...
      "MISSÃO SUSPENSA":"MISSION PAUSED","TREINO SUSPENSO":"TRAINING PAUSED","Jogo pausado":"Game paused","Seu progresso está seguro.":"Your progress is safe.","CONTINUAR":"CONTINUE","VOLTAR AO MENU":"BACK TO MENU","MISSÃO ENCERRADA":"MISSION ENDED","TREINO ENCERRADO":"TRAINING ENDED","Fim de jogo":"Game over","PONTUAÇÃO":"SCORE","NOVO RECORDE!":"NEW RECORD!","NOVO RECORDE NUMPAD!":"NEW NUMPAD RECORD!","JOGAR NOVAMENTE":"PLAY AGAIN",
    ...
    fr: {
      ...
      "MISSÃO SUSPENSA":"MISSION EN PAUSE","TREINO SUSPENSO":"ENTRAÎNEMENT EN PAUSE","Jogo pausado":"Jeu en pause","Seu progresso está seguro.":"Votre progression est sauvegardée.","CONTINUAR":"CONTINUER","VOLTAR AO MENU":"RETOUR AU MENU","MISSÃO ENCERRADA":"MISSION TERMINÉE","TREINO ENCERRADO":"ENTRAÎNEMENT TERMINÉ","Fim de jogo":"Fin de partie","PONTUAÇÃO":"SCORE","NOVO RECORDE!":"NOUVEAU RECORD !","NOVO RECORDE NUMPAD!":"NOUVEAU RECORD NUMÉRIQUE !","JOGAR NOVAMENTE":"REJOUER",
    ...
    es: {
      ...
      "MISSÃO SUSPENSA":"MISIÓN EN PAUSA","TREINO SUSPENSO":"ENTRENAMIENTO EN PAUSA","Jogo pausado":"Juego pausado","Seu progresso está seguro.":"Tu progreso está seguro.","CONTINUAR":"CONTINUAR","VOLTAR AO MENU":"VOLVER AL MENÚ","MISSÃO ENCERRADA":"MISIÓN FINALIZADA","TREINO ENCERRADO":"ENTRENAMIENTO FINALIZADO","Fim de jogo":"Fin del juego","PONTUAÇÃO":"PUNTUACIÓN","NOVO RECORDE!":"¡NUEVO RÉCORD!","NOVO RECORDE NUMPAD!":"¡NUEVO RÉCORD NUMPAD!","JOGAR NOVAMENTE":"JUGAR DE NUEVO",
